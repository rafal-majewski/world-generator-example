...
import {DiscardFragmentShaderSourceCodeMainStatements} from "./DiscardFragmentShaderSourceCodeMainStatements.ts";
...
import {WithFinalDiscardFragmentShaderSourceCodeMainStatementsBuilder} from "./WithFinalDiscardFragmentShaderSourceCodeMainStatementsBuilder.ts";
...
> {
	...
	public discard(): WithFinalDiscardFragmentShaderSourceCodeMainStatementsBuilder {
		const statements = new DiscardFragmentShaderSourceCodeMainStatements();
		const newBuilder = new WithFinalDiscardFragmentShaderSourceCodeMainStatementsBuilder(
			statements,
		);
		return newBuilder;
	}
	...
	> {
		...
		const statements = new AssignmentFragmentShaderSourceCodeMainStatements(name, value);
	...
	> {
		...
		const statements = new IfFragmentShaderSourceCodeMainStatements(conditionValue);
